...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA1     ------> ADC1_INP1
    */
    GPIO_InitStruct.Pin = ADC1_INPUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC1_INPUT_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PF13     ------> ADC2_INP2
    */
    GPIO_InitStruct.Pin = ADC2_INPUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC2_INPUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_INP1
    */
    HAL_GPIO_DeInit(ADC1_INPUT_GPIO_Port, ADC1_INPUT_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PF13     ------> ADC2_INP2
    */
    HAL_GPIO_DeInit(ADC2_INPUT_GPIO_Port, ADC2_INPUT_Pin);
